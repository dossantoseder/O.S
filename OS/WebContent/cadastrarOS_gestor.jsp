...
%>
    ...
    <div id="main">
           ...
           <div id="bar2">    
            <div id="divbar2"><h2>Nova Ordem de Serviço</h2></div>  
           </div>
	...
	<form id="form2"  action="Servlet.Controlador" method="post">  
		...
		<!--================================-->	
				<strong>
				  ...
				  <select name="idsolicitante"  class="itens_valor" id="l4"  style="width: 440px">
				   <option value="" selected="selected"></option>
		...
		<!--================================-->	
				<strong>
				  ...
				  <select name="idservico"  class="itens_valor" id="l5"  style="width: 440px">
				   <option value="" selected="selected"></option>
         ...
         <%}%>
		  ...
		  <label class="itens">
				  ...
				  <select name="idequipamento"  class="itens_valor" id="l4"  style="width: 440px">
				   <option value="" selected="selected"></option>
