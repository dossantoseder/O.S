...
<html>
    <head>
        ...
        <title>CADASTRAR EXECUTOR</title>
    ...
    <div id="main">
           ...
           <div id="bar2">    
            <div id="divbar2"><h2>Novo Executor</h2></div>  
           </div>
  ...
  <br><br><br><br>      
	...
	<form id="form2"  method="post" action="index.jsp">  
	 ...
	 <!--================================-->
				<strong> <label class="itens"> Tipo de Serviço: </label>
			</strong> <select name="idservico" class="itens_valor" id="e1"
				style="width: 440px">
