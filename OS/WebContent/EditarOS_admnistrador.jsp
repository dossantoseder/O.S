...
<body id="main_body" >
<c:import url="cabecalho_gestor.jsp"/>	
	...
	<div id="form_container">
        ...
        <li id="li_5" >
		<label class="description" for="idservico">Tipo de Serviço </label>
		<div>
		...
		<div>
         ...
         <li id="li_9" >
		<label class="description" for="element_9">Observações </label>
		<div>
			<textarea id="observacoes" name="observacoes" class="element textarea medium"></textarea> 
			  ...
			  <li class="buttons">
                ...
                <input id="saveFormCancela" class="button_text" type="submit" name="submit" value="Serviï¿½o" />
		</li>
			</ul>
		</form>	
	</div>
