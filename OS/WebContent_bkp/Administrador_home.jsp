...
<body>
            ...
            <div id="menuOrdensDeServico"><a href='Servlet.Controlador?controlador = "OrdemDeServicoVisualizar"' target="iframe">Ordens de Serviço</a>&nbsp;&nbsp;&nbsp;</div>
		...
		<div id="iframe_">
			 <!-- RAONI " --><center><iframe src="listarOS_admegestor.jsp" id="iframeid" name="iframe" frameborder="0" width="100%"  onload='javascript:resizeIframe(this);'></iframe>
		</div>
